/**
 * List component that displays an item (e.g., an actor) with an image, name, and description.
 * @param {Object} props - The component props.
 * @param {string} props.foto - The URL of the image.
 * @param {string} props.nombre - The name of the item.
 * @param {boolean} [props.esNota10] - Whether the item is associated with a highly rated movie.
 * @param {React.ReactNode} props.children - The description or content to display.
...
function List(props) {
  ...
  return (
    <article
      ...
      aria-label={`${nombre}${
        esNota10 ? ", intérprete en película destacada" : ""
      }`}
    >
